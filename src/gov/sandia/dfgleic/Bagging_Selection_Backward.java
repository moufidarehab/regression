 ...
 */
public class Bagging_Selection_Backward extends Configured implements Tool {
    private static final Logger sLogger = Logger.getLogger(Bagging_Selection_Backward.class);



    public static void main(String args[]) throws Exception {
        // Let ToolRunner handle generic command-line options
        int res = ToolRunner.run(new Configuration(), new Bagging_Selection_Backward(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        for (int stage=0; stage<stages.length; ++stage) {
            ...
            JobConf conf = new JobConf(getConf(), Bagging_Selection_Backward.class);
