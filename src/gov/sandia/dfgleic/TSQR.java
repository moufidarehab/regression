...
public class  TSQR extends Configured implements Tool {
    private static final Logger sLogger = Logger.getLogger(String.valueOf(TSQR.class));
        ...
        for (int stage=0; stage<stages.length; ++stage) {
         ...
         conf.setInputFormat(SequenceFileInputFormat.class);
          conf.setOutputFormat(SequenceFileOutputFormat.class);
            ...
            //conf.setJar("/home/hubiquitus/Desktop/regression/out/artifacts/regression_jar/regression.jar");
