 ...
 */
public class Bagging_Selection_Map extends Configured implements Tool {
    private static final Logger sLogger = Logger.getLogger(Bagging_Selection_Map.class);



    public static void main(String args[]) throws Exception {
        // Let ToolRunner handle generic command-line options
        int res = ToolRunner.run(new Configuration(), new Bagging_Selection_Map(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        for (int stage=0; stage<stages.length; ++stage) {
            ...
            JobConf conf = new JobConf(getConf(), Bagging_Selection_Map.class);
            ...
            extends MapReduceBase
    {
        ...
        public String SelectONE(Hashtable<String,DenseVector> S, Hashtable<String,DenseVector> H_S, Hashtable<String,Double> Somm_Residual_ALL) throws IOException
        {
            String key_select = "";
        ...
        public Hashtable<String, DenseVector> Forward_Selection()  throws IOException
        {
            ...
            while (!endSelection) {
                ...
                key = SelectONE(S, H_S, Somm_Residual_ALL); //comparaison avec le MSE de l'itération précédente
