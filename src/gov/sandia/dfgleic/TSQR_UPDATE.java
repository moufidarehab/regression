 ...
 * reduceSchedule:
 */
public class  TSQR_UPDATE extends Configured implements Tool {
    private static final Logger sLogger = Logger.getLogger(TSQR_UPDATE.class);


    public static void main(String args[]) throws Exception {
        // Let ToolRunner handle generic command-line options
        int res = ToolRunner.run(new Configuration(), new TSQR_UPDATE(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        sLogger.info("Tool name: TSQR_UPDATE");
        ...
        for (int stage=0; stage<stages.length; ++stage) {
            ...
            JobConf conf = new JobConf(getConf(), TSQR_UPDATE.class);
    ...
    public static class TSQRMapper_Y
            extends TSQRIteration
            implements Mapper<TypedBytesWritable, TypedBytesWritable,Text, TypedBytesWritable> {
        ...
        public void map(TypedBytesWritable key, TypedBytesWritable value,
            ...
            // envoyer direct le vecteur Y

            output.collect(KeyY, value);
        ...
        public void reduce(Text key, Iterator<TypedBytesWritable> values,
            ...
            while (values.hasNext()) {
                ...
                else
                {
                    ...
                    if (row_ids == null)
                    {
                        row_ids = new ArrayList<Long>();
                    }
                    row_ids.add(Long.parseLong(key.toString().substring(1)));
    ...
    public static class TSQRReducer2
        ...
        public void reduce(Text key, Iterator<TypedBytesWritable> values,
            ...
            if (flagQ1 && flagQ2 )
            {
                ...
                Y = new DenseVector(Q1.numColumns());
