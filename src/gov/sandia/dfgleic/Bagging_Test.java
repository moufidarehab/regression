...
public class Bagging_Test
    ...
    public static void main(String [] argv) throws Exception {
        ...
        classifier.getLibrary().addModel(classifier.getLibrary().createModel(B));
        ...
        BufferedReader testReader = new BufferedReader(new FileReader(
                "/home/hubiquitus/Desktop/regression/out/artifacts/regression_jar/houses1.arff"));
        // Set up the Instances Object
        Instances test;
        int classIndex = -1;
        String classIndexString = "4";
        ...
        Instances we = new Instances(B.createDataset1(B.Output_weight2()));
